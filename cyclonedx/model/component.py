...
class ToolReference:
    ...
    def __eq__(self, other: object) -> bool:
        return isinstance(other, ToolReference) and self.ref == other.ref

    def __lt__(self, other: 'ToolReference') -> bool:
...
class _ToolsSerializationHelper(serializable.helpers.BaseHelper):
    @classmethod
    def json_normalize(cls, o: Any, **__: Any) -> Any:
        if isinstance(o, SortedSet):
            return [str(t) for t in o]
        return o

    @classmethod
    def xml_normalize(cls, o: Any, **__: Any) -> Any:
        if isinstance(o, SortedSet):
            return list(o)  # Keep as ToolReference objects for XML
        return o

    @classmethod
    def deserialize(cls, o: Any) -> SortedSet[ToolReference]:
        if isinstance(o, (list, set, tuple)):
            return SortedSet(ToolReference(ref=str(t)) for t in o)
        return SortedSet([ToolReference(ref=str(o))])
...
class Identity:
    ...
    @serializable.xml_sequence(5)
    @serializable.json_name('tools')
    def tools(self) -> 'SortedSet[ToolReference]':
        """
        ...
        Returns:
            Set of tool references as strings
        """
        return self._tools

    @tools.setter
    def tools(self, tools: Iterable[Union[str, BomRef]]) -> None:
        """Convert all inputs to strings for consistent storage"""
        self._tools = SortedSet(ToolReference(ref=str(t)) for t in tools)
...
class Occurrence:
    ...
    def __init__(
        ...
        self.bom_ref = _bom_ref_from_str(bom_ref)
    ...
    @bom_ref.setter
    def bom_ref(self, bom_ref: Optional[BomRef]) -> None:
...
class CallStack:
    ...
    def __comparable_tuple(self) -> _ComparableTuple:
        return _ComparableTuple((_ComparableTuple(self.frames)))
...
class ComponentEvidence:
    ...
    def identity(self) -> 'SortedSet[Identity]':
        ...
        return self._identity  # This matches our initialization attribute name
