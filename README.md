...
OWASP [CycloneDX][link_website] is a system‑transparency standard that delivers full‑stack Bills of Materials (BOMs) and advanced supply‑chain insights across the entire product lifecycle.
