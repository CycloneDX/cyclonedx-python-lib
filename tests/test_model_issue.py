...
class TestModelIssueType(TestCase):
    ...
    def test_sort(self) -> None:
        ...
        issues = [
            IssueType(type_=IssueClassification.SECURITY, id_='a', name='a', description='a', source=source_a),
            IssueType(type_=IssueClassification.SECURITY, id_='a', name='a', description='a', source=source_b),
            IssueType(type_=IssueClassification.SECURITY, id_='a', name='a', description='a'),
            IssueType(type_=IssueClassification.SECURITY, id_='a', name='a'),
            IssueType(type_=IssueClassification.SECURITY, id_='a'),
            IssueType(type_=IssueClassification.DEFECT, id_='a', name='a', description='a', source=source_b),
            IssueType(type_=IssueClassification.DEFECT, id_='a', name='a', description='a', source=source_a),
        ]
